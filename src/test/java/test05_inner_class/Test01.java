...
import test05_inner_class.Outer01.Inner01;
import test05_inner_class.Outer02.Spider;
...
public class Test01 {
	...
	public void test04() {
		...
		test05_inner_class.Outer04.Spider spiderman = outer.getSpiderman("Parker", "New York");
